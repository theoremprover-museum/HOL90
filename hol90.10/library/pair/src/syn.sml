...
(*           quantifications.                                           *)
(* ---------------------------------------------------------------------*)
(*$Id: syn.sml,v 1.2.4.1 1997/07/14 17:26:54 kxs Exp $*)

(* =====================================================================*)
(* Constructors for paired HOL syntax.                                  *)
(* =====================================================================*)

signature Pair_syn_sig =
  sig
   type hol_type
   type term
...
structure Pair_syn:Pair_syn_sig =
struct
...
val mk_pabs =
	...
	handle _ => PAIR_ERR{function="mk_pabs",message=""}
    end;
...
fun mk_pforall {Bvar=x,Body=t} =
	...
	handle _ => PAIR_ERR{function="mk_pforall",message=""}
    end;
...
fun mk_pexists {Bvar=x,Body=t} =
	...
	mk_comb{Rator=mk_const{Name="?",Ty=exty},
		Rand=mk_pabs{Bvar=x,Body=t}}
	handle _ => PAIR_ERR{function="mk_pexists",message=""}
    end;
...
fun mk_pselect {Bvar=x,Body=t} =
	...
	mk_comb{Rator=mk_const{Name="@",Ty=selty},
		Rand=mk_pabs{Bvar=x,Body=t}}
	handle _ => PAIR_ERR{function="mk_pselect",message=""}
    end;
...
fun dest_pabs tm =
    ...
    handle _ =>PAIR_ERR{function="dest_pabs",message=""};
...
val dest_pforall =
	...
	fn tm => let val _ = (check o # Rator)(dest_comb tm)
	     ...
	     handle _ => PAIR_ERR{function="dest_pforall",message=""}
    end;
...
val dest_pexists =
	...
	fn tm => let val _ = (check o # Rator)(dest_comb tm)
	     ...
	     handle _ => PAIR_ERR{function="dest_pexists",message=""}
    end;
...
val dest_pselect =
	...
	fn tm => let val _ = (check o # Rator)(dest_comb tm)
	     ...
	     handle _ => PAIR_ERR{function="dest_pselect",message=""}
    end;
...
fun bndpair tm = #Bvar (dest_pabs tm) handle _ => failwith "bndpair"
and pbody tm = #Body (dest_pabs tm) handle _ => failwith "pbody" ;
