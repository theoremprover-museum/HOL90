...
(*==========================================================================*)
(*$Id: tactic.sml,v 1.1.1.1.6.1 1997/07/15 13:09:53 kxs Exp $*)

structure WinTactic : sig
                       type thm
                       type tactic
...
in
    fun END_STACK_TAC () = 
        ...
        in
            ...
            Resolve.MATCH_MP_TAC (PMI_IMP th)
        end
end;
