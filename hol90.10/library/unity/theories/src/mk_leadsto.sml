...
if (current_theory() <> "gen_induct") then
    load_theory"gen_induct"
else
    ();

delete_theory (path^"leadsto");
new_theory"leadsto";
...
val True = definition"state_logic""True";

val AND_AND_COMM_lemma = theorem"state_logic""AND_AND_COMM_lemma";
val AND_ASSOC_lemma = theorem"state_logic""AND_ASSOC_lemma";
val AND_COMM_OR_lemma = theorem"state_logic""AND_COMM_OR_lemma";
val AND_COMM_lemma = theorem"state_logic""AND_COMM_lemma";
val AND_False_lemma = theorem"state_logic""AND_False_lemma";
val AND_IMPLY_WEAK_lemma = theorem"state_logic""AND_IMPLY_WEAK_lemma";
val AND_OR_COMM_lemma = theorem"state_logic""AND_OR_COMM_lemma";
val AND_OR_DISTR_lemma = theorem"state_logic""AND_OR_DISTR_lemma";
val AND_True_lemma = theorem"state_logic""AND_True_lemma";
val ENSURES_cor1 = theorem"ensures""ENSURES_cor1";
val ENSURES_cor2 = theorem"ensures""ENSURES_cor2";
val ENSURES_cor6 = theorem"ensures""ENSURES_cor6";
val ENSURES_thm1 = theorem"ensures""ENSURES_thm1";
val ENSURES_thm2 = theorem"ensures""ENSURES_thm2";
val ENSURES_thm3 = theorem"ensures""ENSURES_thm3";
val ENSURES_thm4 = theorem"ensures""ENSURES_thm4";
val GEN_INDUCT_thm = theorem"gen_induct""GEN_INDUCT_thm";
val IMPLY_WEAK_AND_lemma = theorem"state_logic""IMPLY_WEAK_AND_lemma";
val IMPLY_WEAK_lemma6 = theorem"state_logic""IMPLY_WEAK_lemma6";
...
val NOT_NOT_lemma = theorem"state_logic""NOT_NOT_lemma";
val NOT_OR_AND_NOT_lemma = theorem"state_logic""NOT_OR_AND_NOT_lemma";
val OR_AND_COMM_lemma = theorem"state_logic""OR_AND_COMM_lemma";
val OR_AND_DISTR_lemma = theorem"state_logic""OR_AND_DISTR_lemma";
val OR_ASSOC_lemma = theorem"state_logic""OR_ASSOC_lemma";
val OR_COMM_AND_lemma = theorem"state_logic""OR_COMM_AND_lemma";
val OR_COMM_OR_lemma = theorem"state_logic""OR_COMM_OR_lemma";
val OR_COMM_lemma = theorem"state_logic""OR_COMM_lemma";
val OR_False_lemma = theorem"state_logic""OR_False_lemma";
val OR_IMPLY_WEAK_lemma = theorem"state_logic""OR_IMPLY_WEAK_lemma";
val OR_OR_COMM_lemma = theorem"state_logic""OR_OR_COMM_lemma";
val OR_OR_lemma = theorem"state_logic""OR_OR_lemma";
val P_AND_NOT_P_lemma = theorem"state_logic""P_AND_NOT_P_lemma";
val P_OR_NOT_P_lemma = theorem"state_logic""P_OR_NOT_P_lemma";
val SYM_AND_IMPLY_WEAK_lemma = theorem"state_logic""SYM_AND_IMPLY_WEAK_lemma";
val SYM_OR_IMPLY_WEAK_lemma = theorem"state_logic""SYM_OR_IMPLY_WEAK_lemma";
val UNLESS_cor16 = theorem"unless""UNLESS_cor16";
val UNLESS_cor17 = theorem"unless""UNLESS_cor17";
...
val UNLESS_thm8 = theorem"unless""UNLESS_thm8";
 ...
 properties of the given axiomatic definition of LEADSTO:
        ...
        -------------------------------------- (2)
               ...
               ------------------------- (3)
                (?i. p i) leadsto q in Pr
*)
val LUB = new_definition
  ("LUB",
   (--`LUB (P:('a->bool)->bool) = \s:'a. ?p. (P p) /\ p s`--));

val In = new_infix_definition
  ("In",
   (--`In (p:'a->bool) (P:('a->bool)->bool) = P p`--),
   450);

val LeadstoRel = new_definition
  ("LeadstoRel",
   (--`LeadstoRel R Pr =
      !(p:'a->bool) q.
...
*)
val LEADSTO = new_infix_definition
  ("LEADSTO",
...
*)
val LEADSTO_thm3_lemma01 = TAC_PROOF
  (([],
   (--`(!p:'a->bool.
        p In P ==>
        (!R.
...
val LEADSTO_thm3c_lemma01 = TAC_PROOF
  (([],
...
val LEADSTO_thm3c_lemma02 = TAC_PROOF
  (([],
   (--`!(P:num->'a->bool) q i.
...
val LEADSTO_thm3c_lemma03 = TAC_PROOF
  (([],
...
val LEADSTO_thm3c_lemma04 = TAC_PROOF
  (([],
...
*)
val LEADSTO_thm4_lemma1a = TAC_PROOF
  (([],
   (--`!(p1:'a->bool) p2 s.
...
*)
val LEADSTO_thm4_lemma2 = TAC_PROOF
  (([],
...
(*
  |- !R p1 p2 q Pr. R p1 q Pr ==> R p2 q Pr ==>
      (!p q P. (p = LUB P) /\ (!p. P p ==> R p q Pr) ==> R p q Pr)
           ==> R(p1 \/* p2) q Pr
*)
val LEADSTO_thm4_lemma3 = TAC_PROOF
  (([],
   (--`!R (p1:'a->bool) p2 (q:'a->bool) (Pr:('a->'a)list).
     R p1 q Pr ==> R p2 q Pr ==> 
       (!p q P. (p = LUB P) /\ (!p. P p ==> R p q Pr) ==> R p q Pr) ==>
   ...
   Prove:
      ((p ENSURES q)Pr \/
       ...
       (?P. (p = ($?*  P)) /\ (!i. ((P i) LEADSTO q)Pr))) =
          (p LEADSTO q)Pr
*)
val LEADSTO_thm5_lemma1 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) s. (p s = (\s. ?p'. ((p = p') => T | F) /\ p' s)s)`--)),
   REPEAT GEN_TAC THEN
   BETA_TAC THEN
   EQ_TAC THEN REPEAT STRIP_TAC THENL
    [
     ...
     ASM_REWRITE_TAC []
    ,
     UNDISCH_TAC (--`(((p:'a->bool) = p') => T | F)`--) THEN
...
(*
   |- !p. p = (\s. ?p'. ((p = p') => T | F) /\ p' s)
*)
val LEADSTO_thm5_lemma2 = (GEN_ALL
     (REWRITE_RULE [ETA_AX]
      (MK_ABS (SPEC (--`p:'a->bool`--) LEADSTO_thm5_lemma1))));

val LEADSTO_thm5_lemma3 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) p'. ((p = p') => T | F) = (p = p')`--)),
  ...
  ("LEADSTO_thm5",
   ...
   EQ_TAC THENL
     ...
     ,
      ...
      DISJ2_TAC THEN
      DISJ2_TAC THEN
      EXISTS_TAC (--`\(p':'a->bool). (p = p') => T | F`--) THEN
...
(*
   Theorem LEADSTO_thm10 does ~* hold for the generalised disjunctive
   rule, since:
...
*)
val LEADSTO_thm23_lemma00 = TAC_PROOF
  (([],
   (--`!X Pr.
      ((!p. p In P ==> (p LEADSTO q)Pr) /\ (!p. p In P ==> X p q Pr)) =
       (!p:'a->bool. p In P ==> (p LEADSTO q)Pr /\ X p q Pr)`--)),
...
val LEADSTO_thm23_lemma01 = TAC_PROOF
  (([],
   (--`!X Pr.
      (!(p:'a->bool) q.
         ((p ENSURES q)Pr ==> (p LEADSTO q)Pr /\ X p q Pr) /\
...
val LEADSTO_thm24_lemma01 = TAC_PROOF
  (([],
   (--`!X Pr.
     (!(p:'a->bool) q.
       ((p ENSURES q)Pr ==> X p q Pr) /\
...
val LEADSTO_thm29_lemma05_2 = TAC_PROOF
  (([],
...
val LEADSTO_thm29_lemma05_3 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) P r.
...
val LEADSTO_thm29_lemma05_4 = TAC_PROOF
  (([],
   (--`!s:'a.
      ((LUB P)  /\*  r)s =
...
val LEADSTO_thm29_lemma05_5 = TAC_PROOF
  (([],
...
val LEADSTO_thm29_lemma05_6 = TAC_PROOF
  (([],
   (--`!(P:('a->bool)->bool) r q' b st Pr.
       (!p''.
        p'' In P ==>
...
val LEADSTO_thm29_lemma05 = TAC_PROOF
  (([],
...
*)
val LEADSTO_thm30_lemma00 = BETA_RULE
  (SPEC (--`CONS (st:'a->'a) Pr`--) (GEN (--`Pr:('a->'a)list`--) (BETA_RULE (SPEC_ALL (SPEC
   (--`\(p:'a->bool) (q:'a->bool) (Pr:('a->'a)list). (q = False) ==> (!s. ~* p s)`--)
   LEADSTO_thm21)))));

val LEADSTO_thm30_lemma01 = TAC_PROOF
  (([],
   (--`!(r:'a->bool). (!s. ~* r s) ==> (!s. r s = False s)`--)),
...
(*
  |- (!s. ~* r s) ==> (r = False)
*)
val LEADSTO_thm30_lemma02 = (DISCH_ALL (REWRITE_RULE [ETA_AX] (MK_ABS (UNDISCH
     (SPEC_ALL LEADSTO_thm30_lemma01)))));

val LEADSTO_thm30_lemma03 = TAC_PROOF
  (([],
  (--`!p:'a->bool.
...
val LEADSTO_thm30_lemma04 = TAC_PROOF
  (([],
   (--`!(p':'a->bool) (q':'a->bool).
...
(* Now Prove:
   |- !p st Pr. (p LEADSTO False)(CONS st Pr) ==> (!s. ~* p s)
*)
val LEADSTO_thm30 = prove_thm
  ("LEADSTO_thm30",
   (--`!(p:'a->bool) st Pr. (p LEADSTO False)(CONS st Pr) ==> (!s. ~* p s)`--),
   REPEAT STRIP_TAC THEN 
...
*)
val LEADSTO_cor1 = prove_thm
  ("LEADSTO_cor1",
   (--`!(p:'a->bool) b q Pr.
       ((p  /\*  b) LEADSTO q) Pr /\ ((p  /\*  (~* b)) LEADSTO q) Pr
           ==> (p LEADSTO q) Pr`--),
   REPEAT STRIP_TAC THEN
   IMP_RES_TAC (SPECL [(--`(p:'a->bool)  /\*  b`--),(--`(p:'a->bool)  /\*  (~* b)`--),
   ...
   ACCEPT_TAC (REWRITE_RULE [SYM (SPEC_ALL AND_OR_DISTR_lemma),
    ...
    (ASSUME (--`((((p:'a->bool)  /\*  b) \/* (p  /\*  (~* b))) LEADSTO q)Pr`--))));
...
val LEADSTO_cor4 = prove_thm
  ("LEADSTO_cor4",
   ...
   ASSUME_TAC (REWRITE_RULE [OR_OR_lemma] (ASSUME
    (--`(((p:'a->bool) /\* (~* b)) LEADSTO (q \/* q))(CONS st Pr)`--))) THEN
   IMP_RES_TAC LEADSTO_cor1);
...
val LEADSTO_cor5 = prove_thm
  ("LEADSTO_cor5",
   ...
   ASSUME_TAC (REWRITE_RULE [NOT_NOT_lemma]
    (SPECL [(--`~* (r:'a->bool)`--),(--`CONS (st:'a->'a) Pr`--)] UNLESS_thm2)) THEN
   IMP_RES_TAC LEADSTO_thm29 THEN
   ASSUME_TAC (REWRITE_RULE [AND_ASSOC_lemma,P_AND_NOT_P_lemma] (ASSUME
    (--`((((p:'a->bool) /\* q) /\* (~* r)) LEADSTO ((r /\* (~* r)) \/* r))
                                               (CONS st Pr)`--))) THEN
   ASSUME_TAC (REWRITE_RULE [OR_False_lemma] (ONCE_REWRITE_RULE
    [OR_COMM_lemma] (ASSUME (--`(((p:'a->bool) /\* (q /\* (~* r))) LEADSTO
                             (False \/* r))(CONS st Pr)`--)))) THEN
   ASSUME_TAC (MP
    (SPEC_ALL (SPECL [(--`r:'a->bool`--),(--`(~* (q:'a->bool)) \/* r`--)] LEADSTO_thm25))
    (SPECL [(--`r:'a->bool`--),(--`~* (q:'a->bool)`--)] SYM_OR_IMPLY_WEAK_lemma)) THEN
   IMP_RES_TAC LEADSTO_thm1);
...
*)
val LEADSTO_cor8 = prove_thm
  ("LEADSTO_cor8",
   (--`!(p:'a->bool) r q st Pr. (p LEADSTO r)(CONS st Pr)
                   ==> ((p /\* q) LEADSTO r)(CONS st Pr)`--),
   REPEAT STRIP_TAC THEN
   ASSUME_TAC (SPECL [(--`p:'a->bool`--),
		      (--`q:'a->bool`--)] SYM_AND_IMPLY_WEAK_lemma) THEN
   IMP_RES_TAC LEADSTO_thm25 THEN
   ASSUME_TAC (SPEC_ALL (ASSUME
    (--`!Pr st. (((p:'a->bool) /\* q) LEADSTO p)(CONS st Pr)`--))) THEN
   IMP_RES_TAC LEADSTO_thm1);
...
val LEADSTO_cor9 = prove_thm
  ("LEADSTO_cor9",
   ...
   IMP_RES_TAC LEADSTO_thm25 THEN
   ASSUME_TAC (SPEC_ALL (ASSUME
    (--`!Pr st. ((q:'a->bool) LEADSTO r)(CONS st Pr)`--))) THEN
   IMP_RES_TAC LEADSTO_thm1);
...
*)
val LEADSTO2MinFixThm = TAC_PROOF
  (([],
   (--`!R. (R = LEADSTO2Fn R)
...
*)
val LEADSTO2InductThm = TAC_PROOF
  (([],
...
*)
val LEADSTO2Fam = new_definition
  ("LEADSTO2Fam",
   (--`LEADSTO2Fam R Pr =
     !(p:'a->bool) (q:'a->bool).
         ((p ENSURES q) Pr                 ==> R p q Pr) /\
...
*)
val LEADSTO2Fn_EQ_LEADSTO2Fam = TAC_PROOF
  (([],
   (--`!R Pr.
...
*)
val LEADSTO2_thm3_lemma1 = TAC_PROOF
  (([],
   (--`(!p:'a->bool. p In P ==>
     (!R.
       (!p q.
...
(*
  |- !p1 p2 s. (p1 \/* p2)s = LUB(\p. (p = p1) \/ (p = p2))s
*)
val LEADSTO2_thm4_lemma1a = TAC_PROOF
  (([],
...
(*
  |- !p1 p2. p1 \/* p2 = LUB(\p. (p = p1) \/ (p = p2))
*)
val LEADSTO2_thm4_lemma1 =  (GEN_ALL (REWRITE_RULE [ETA_AX] (MK_ABS (GEN (--`s:'a`--)
...
*)
val LEADSTO2_thm4_lemma2 = TAC_PROOF
  (([],
...
(*
  |- !R p1 p2 q Pr Pr. R p1 q Pr ==> R p2 q Pr ==>
                          (!p. (\p. (p = p1) \/ (p = p2))p ==> R p q Pr)
*)
val LEADSTO2_thm4_lemma3 = TAC_PROOF
  (([],
...
(*
  |- !R p1 p2 q Pr. R p1 q Pr ==> R p2 q Pr ==>
       (!p q P. (p = LUB P) /\ (!p. p In P ==> R p q Pr) ==> R p q Pr) ==>
                 R(p1 \/* p2)q Pr
*)
val LEADSTO2_thm4_lemma4 = TAC_PROOF
  (([],
...
(* Prove:
   ...
   This is more difficult /\* we need to use structural induction
...
val LEADSTO2_thm2a = (BETA_RULE (SPECL
...
(*
  |- !p' q' P.
      (!p''. p'' In P ==> (!r. LEADSTO2 q' r Pr ==> LEADSTO2 p'' r Pr)) ==>
         (!r. LEADSTO2 q' r Pr ==> LEADSTO2(LUB P)r Pr)
*)
val LEADSTO2_thm2d_lemma1 = TAC_PROOF
  (([],
   (--`!(q':'a->bool) r Pr.
     LEADSTO2 q' r Pr ==>
...
*)
val LEADSTO2_thm7_lemma01 = TAC_PROOF
  (([],
  (--`(!p':'a->bool.
...
val LEADSTO2_thm7_lemma = TAC_PROOF
  (([],
   (--`!X Pr.
     (!(p:'a->bool) q.
        ((p ENSURES q)Pr ==> X p q Pr) /\
...
*)
val LEADSTO_EQ_LEADSTO2a = TAC_PROOF
  (([],
   (--`!R (Pr:('a->'a)list).
...
*)
val LEADSTO_EQ_LEADSTO2b_lemma = TAC_PROOF
  (([],
   (--`(!(p:'a->bool) q.
        ((p ENSURES q)Pr ==> R p q Pr) /\
        (!r. R p r Pr /\ R r q Pr ==> R p q Pr) /\
...
val LEADSTO_EQ_LEADSTO2b = TAC_PROOF
  (([],
...
*)
val LEADSTO_EQ_LEADSTO2c = (SPECL
  [(--`LEADSTO2:('a->bool)->('a->bool)->(('a->'a)list)->bool`--),
...
*)
val LEADSTO_EQ_LEADSTO2 = prove_thm
  ("LEADSTO_EQ_LEADSTO2",
...
*)
val LEADSTO_thm34a_lemma1 = TAC_PROOF
  (([],
...
val LEADSTO_thm34a_lemma2 = TAC_PROOF
  (([],
   (--`!P q Pr. (!p:'a->bool. p In P ==> (p LEADSTO q)Pr) ==>
                   (!p. p In P ==> X p q Pr) ==>
                       (!p. p In P ==> (p LEADSTO q)Pr ==> X p q Pr)`--)),
...
val LEADSTO_thm34a_lemma3 = TAC_PROOF
  (([],
...
*)
val LEADSTO_thm35_lemma00 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) q st Pr.
     (p ENSURES q)(CONS st Pr) /\ (p' LEADSTO q')(CONS st Pr) /\
     (q UNLESS r)(CONS st Pr) /\ (q' UNLESS r)(CONS st Pr)
...
val LEADSTO_thm35_lemma01_1 = TAC_PROOF
  (([],
...
val LEADSTO_thm35_lemma01_4 = TAC_PROOF
  (([],
   (--`!(P:('a->bool)->bool) r q st Pr.
    (!p. p In P ==> ((p /\* r) LEADSTO q)(CONS st Pr)) ==>
    (!p. p In P ==> (p LEADSTO q)(CONS st Pr)) ==>
...
val LEADSTO_thm35_lemma01_5 = TAC_PROOF
  (([],
...
val LEADSTO_thm35_lemma01_6 = TAC_PROOF
  (([],
   (--`!s:'a.
      (p /\* (LUB P))s =
...
val LEADSTO_thm35_lemma01_7 = TAC_PROOF
  (([],
...
val LEADSTO_thm35_lemma01_8 = TAC_PROOF
  (([],
   (--`!(P:('a->bool)->bool) r' q q' st Pr.
       (!p'.
...
val LEADSTO_thm35_lemma01_9 = TAC_PROOF
  (([],
   (--`(!p:'a->bool.
        p In P ==>
        (!p' q' r.
...
val LEADSTO_thm35_lemma01_10 = TAC_PROOF
  (([],
...
val LEADSTO_thm35_lemma01 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) q st Pr.
     (p LEADSTO q)(CONS st Pr) ==>
   ...
   LEADSTO_INDUCT0_TAC THENL
       ...
       ACCEPT_TAC (REWRITE_RULE [OR_OR_lemma] (REWRITE_RULE
        [(ASSUME
         ...
         (ASSUME (--`(((p:'a->bool) /\* p') LEADSTO
           ...
           [(--`(p:'a->bool) /\* p'`--),(--`((q:'a->bool) /\* q') \/* r''`--),
            (--`(p:'a->bool) /\* r`--),(--`((q:'a->bool) /\* q') \/* r''`--),(--`st:'a->'a`--),
            (--`Pr:('a->'a)list`--)] LEADSTO_thm28)))
      ,
       REPEAT STRIP_TAC THEN
       IMP_RES_TAC LEADSTO_thm0 THEN
       IMP_RES_TAC LEADSTO_thm2 THEN
    ...
    ,
     ...
     ONCE_REWRITE_TAC
      [SPECL [(--`LUB (P:('a->bool)->bool)`--),(--`p':'a->bool`--)] AND_COMM_lemma] THEN
     ASM_REWRITE_TAC []
    ]);
...
(*
  We need to define the metric predicates EQmetric /\* LESSmetric
*)
...
*)
val EQmetric = new_infix_definition
  ("EQmetric", (--`EQmetric (M:'a->num) m = \s. M s = m`--), 450);
...
*)
val LESSmetric = new_infix_definition
  ("LESSmetric", (--`LESSmetric (M:'a->num) m = \s. M s < m`--), 450);
...
val LEADSTO_thm36_lemma00 = BETA_RULE
   (SPEC (--`\n. (((p:'a->bool) /\* (M EQmetric n)) LEADSTO q)(CONS st Pr)`--)
         GEN_INDUCT_thm);

val LEADSTO_thm36_lemma01 = TAC_PROOF
  (([],
   (--`!(M:'a->num) m. (p /\* (M EQmetric m)) = ((\i. p /\* (M EQmetric i))m)`--)),
   BETA_TAC THEN
   REWRITE_TAC []);

val LEADSTO_thm36_lemma02 = TAC_PROOF
  (([],
...
val LEADSTO_thm36_lemma03 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) q st Pr M m.
      (!n. n < m ==> ((p /\* (M EQmetric n)) LEADSTO q) (CONS st Pr)) ==>
...
val LEADSTO_thm36_lemma04 = TAC_PROOF
  (([],
   (--`!M:'a->num. (!m s. (M LESSmetric m)s = ( \</*  (\i. M EQmetric i) m) s)`--)),
   GEN_TAC THEN
   INDUCT_TAC THENL
     [
      REWRITE_TAC [LESSmetric,EQmetric, \</* ,False,NOT_LESS_0]
     ,
      GEN_TAC THEN
...
val LEADSTO_thm36_lemma05 = TAC_PROOF
  (([],
...
val LEADSTO_thm36_lemma06 = TAC_PROOF
  (([],
  (--`!(p:'a->bool) M q Pr.
...
val LEADSTO_thm36_lemma07 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) M m.
...
val LEADSTO_thm36_lemma08 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) q st Pr M.
       (!m. ((p /\* (M EQmetric m)) LEADSTO
...
val LEADSTO_thm36_lemma09 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) q st Pr M.
       (!m. ((p /\* (M EQmetric m)) LEADSTO
            ((p /\* (M LESSmetric m)) \/* q)) (CONS st Pr)) ==>
...
val LEADSTO_thm36_lemma10s = TAC_PROOF
  (([],
   (--`!(p:'a->bool) M s.
...
(*
  Needed due to SPEC
*)
val LEADSTO_thm36_lemma10 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) M.
       (p /\* ($?* (\n. M EQmetric n))) =
       ($?* (\i. p /\* (M EQmetric i)))`--)),
   REPEAT STRIP_TAC THEN
   REWRITE_TAC [
     REWRITE_RULE [SPEC (--`(p:'a->bool) /\* ($?* (\n. M EQmetric n))`--)
      (INST_TYPE
       [{residue= ==`:'a`==,   redex= ==`:'a`==},
	{residue= ==`:bool`==, redex= ==`:'b`==}] ETA_AX),
      SPEC (--`$?* (\i. (p:'a->bool) /\* (M EQmetric i))`--)
           (INST_TYPE
	    [{residue= ==`:'a`==,   redex= ==`:'a`==},
	     {residue= ==`:bool`==, redex= ==`:'b`==}] ETA_AX)]
         (MK_ABS (SPECL [(--`p:'a->bool`--),
			 (--`M:'a->num`--)] LEADSTO_thm36_lemma10s))]);

val LEADSTO_thm36_lemma11s = TAC_PROOF
  (([],
   (--`!(M:'a->num) s. ($?*  (\n. M EQmetric n))s = True s`--)),
   REWRITE_TAC [?* ,EQmetric,True] THEN
   BETA_TAC THEN
   REPEAT GEN_TAC THEN
   EXISTS_TAC (--`(M:'a->num) s`--) THEN
   REFL_TAC);

val LEADSTO_thm36_lemma11 = TAC_PROOF
  (([],
   (--`!(M:'a->num). ($?*  (\n. M EQmetric n)) = True`--)),
   GEN_TAC THEN
   REWRITE_TAC [REWRITE_RULE
     [SPEC (--`$?* (\n. (M:'a->num) EQmetric n)`--)
      ...
      SPEC (--`True:'a->bool`--)
	    ...
	    [{residue= ==`:'a`==,   redex= ==`:'a`==},
	     {residue= ==`:bool`==, redex= ==`:'b`==}] ETA_AX)]
        (MK_ABS (SPEC (--`M:'a->num`--) LEADSTO_thm36_lemma11s))]);

val LEADSTO_thm36_lemma12 = TAC_PROOF
  (([],
   (--`!(p:'a->bool) q st Pr M.
      (!m. ((p /\* (M EQmetric m)) LEADSTO
           ((p /\* (M LESSmetric m)) \/* q))(CONS st Pr))
...
*)
val LEADSTO_thm37_lemma00 = TAC_PROOF
  (([],
...
val LEADSTO_thm37_lemma01 = TAC_PROOF
  (([],
...
val LEADSTO_thm37_lemma02 = TAC_PROOF
  (([],
...
val LEADSTO_thm39_lemma00 = TAC_PROOF
  (([],
   (--`!(X:('a->bool)->('a->bool)->bool) Pr.
...
val LEADSTO_thm39_lemma01 = TAC_PROOF
  (([],
   (--`!(X:('a->bool)->('a->bool)->bool) Pr.
       (!p q.
         ((p ENSURES q)Pr ==>
...
*)
val LEADSTO_thm42_lemma00 = TAC_PROOF
  (([],
   (--`!X Pr.
...
val LEADSTO_thm42_lemma01 = TAC_PROOF
  (([],
   (--`!X Pr.
      (!(p:'a->bool) q.
       ((p ENSURES q)Pr ==> X p q Pr) /\
...
val LEADSTO_thm42_lemma02 = TAC_PROOF
  (([],
   (--`!X Pr.
     (!(p:'a->bool) q.
      ((p ENSURES q)Pr ==> X p q Pr) /\
...
val LEADSTO_cor13_lemma01 = TAC_PROOF
  (([],
   (--`!(Q:num->('a->bool)) r s.
       ((((/<=\* Q i) \/* r) /\* ((Q(SUC i)) \/* r)) \/* r)s
      =
  ...
  ("LEADSTO_cor13",
   ...
   INDUCT_TAC THENL
    ...
    ,
     ...
     ASSUME_TAC (REWRITE_RULE
      [ASSUME (--`((/<=\* (Q:num->'a->bool) i) UNLESS r)(CONS st Pr)`--),UNLESS_thm1]
       (SPECL
        [(--`/<=\* (Q:num->('a->bool))i`--),(--`r:'a->bool`--),(--`r:'a->bool`--),(--`CONS(st:'a->'a)Pr`--)]
          UNLESS_thm8)) THEN
     ASSUME_TAC (REWRITE_RULE
      [ASSUME (--`(((Q:num->'a->bool)(SUC i)) UNLESS r)(CONS st Pr)`--),UNLESS_thm1]
       (SPECL
...
*)
val LEADSTO_cor16_lemma1 = TAC_PROOF
  (([],
