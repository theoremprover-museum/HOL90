(* ===================================================================== *)
(* FILE		: utilsLib.sml 	(formerly functions.sml and before that, *)
(*                               start_groups.ml)	        	*)
...
open Exception Lib CoreHol.Term CoreHol.Dsyntax CoreHol.Thm 
     Drule Tactical Tactic Conv Parse Rsyntax;

infix THENL THEN ORELSE;


fun UTILSLIB_ERR{function,message} =
    HOL_ERR{origin_structure = "utilsLib",
