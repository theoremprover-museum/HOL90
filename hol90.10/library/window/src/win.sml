...
(*==========================================================================*)
(*$Id: win.sml,v 1.2.2.1.2.1 1997/07/15 13:09:58 kxs Exp $*)
...
type path = Rules.path;
type window = WinCore.window;

open ML_ext Hol_ext;
open Rules WinCore Relations;
open Lib CoreHol;
open Term Dsyntax Rewrite Thm  Drule Conv;
...
and REWRITE_WIN = GEN_REWRITE_WIN TOP_DEPTH_CONV (implicit_rewrites())
and ONCE_REWRITE_WIN = GEN_REWRITE_WIN ONCE_DEPTH_CONV (implicit_rewrites());
