signature Qsig =
  sig
    ...
    val PAT_UNDISCH_TAC : term frag list -> tactic
    val UNDISCH_THEN : term frag list -> thm_tactic -> tactic
    ...
    val X_SKOLEM_CONV : term frag list -> conv
    ...
    val ABBREV_TAC : term frag list -> tactic
    val UNABBREV_TAC : term frag list -> tactic
  end 
