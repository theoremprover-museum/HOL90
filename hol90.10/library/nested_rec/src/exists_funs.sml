...
structure ExistsFuns:ExistsFunsSig =
struct
...
open Type Term Dsyntax Match Thm Theory Drule Tactical Tactic Conv Rewrite
     Resolve Thm_cont;
...
(*
            (PURE_ONCE_REWRITE_RULE
             [(ALPHA_CONV (mk_var {Name = #Name (dest_var y),
                                   Ty = mk_vartype "'b"}) lambdaQ2)]
             lemma2)
*)
