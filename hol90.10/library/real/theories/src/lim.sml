...
map autoload_definitions ["REAL", "TOPOLOGY", "NETS", "SEQ"];

map autoload_theorems ["REAL", "TOPOLOGY", "NETS", "SEQ"];
...
val DIFF_SUM = prove_thm("DIFF_SUM",
  ...
  BETA_TAC THEN CONJ_TAC THEN FIRST_ASSUM MATCH_MP_TAC THENL
   [GEN_TAC THEN DISCH_TAC THEN FIRST_ASSUM MATCH_MP_TAC THEN
    ...
    EXISTS_TAC (--`m + n`--) THEN ASM_REWRITE_TAC[ADD_CLAUSES, LESS_SUC_REFL],
