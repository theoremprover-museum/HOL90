(* Refining to a parity circuit.     *)

(* Load the window library  *)
load_library{library = window_lib, theory = "PARITY"};

(* If you don't have a lot of time or memory, use this:
 *
 *    prim_load_library Lib.compile {lib = window_lib, theory = "PARITY"};
 *
 **********************************************************************)

(* Prove some tautologies                                                    *)
