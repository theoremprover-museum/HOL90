...
open Hol_pp Term Dsyntax Thm Theory Drule Tactical Tactic Conv Rewrite 
open Induct_then Thm_cont Num_conv Parse Prim_rec;;
...
fun conv th (n,m) =
   ...
   in
   ( while (!count <> 0)
     do ( Portable.Ref.dec count;
          Portable.Ref.inc mint;
