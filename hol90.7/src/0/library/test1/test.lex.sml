functor test1_lex(structure Tokens : test1_TOKENS)=
   struct
...
\\000"
val s1 =
"\003\003\003\003\003\003\003\003\003\007\009\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\007\003\003\003\003\003\003\003\003\003\003\003\006\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
...
{fin = [], trans = s1},
{fin = [(N 11)], trans = s0},
{fin = [(N 9),(N 11)], trans = s4},
{fin = [(N 9)], trans = s4},
{fin = [(N 6),(N 11)], trans = s0},
{fin = [(N 4),(N 11)], trans = s7},
{fin = [(N 4)], trans = s7},
{fin = [(N 1)], trans = s0}]
end
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  1 => (lex())
| 11 => (error (("lexer: ignoring bad character "^yytext),0,0); lex())
| 4 => (lex())
| 6 => (Tokens.comma(0,0))
| 9 => (Tokens.ident(yytext,0,0))
